...
{
  /* <Link to="/flights">
<div class="relative max-w-xs overflow-hidden bg-cover bg-no-repeat rounded-sm">
  <img
    src="/images/flight.jpg"
    className="max-w-xs transition duration-300 ease-in-out hover:scale-110"
    alt="Louvre"
  />
  <p className="absolute bottom-0 left-1/2 transform -translate-x-1/2 font-medium w-full h-24 text-xl bg-black text-[#F6F1E9] py-6 text-center bg-opacity-35 px-2 rounded">
    Flight
  </p>
</div>
</Link>
